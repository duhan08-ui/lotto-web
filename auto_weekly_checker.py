...
class AutoWeeklyWinnerChecker:
    ...
    def generate_report(self, result):
        ...
        report.append('  2·3등 (5개 일치): ' + str(len(result['matches']['rank5'])) + '건')
        report.append('  4등 (4개 일치): ' + str(len(result['matches']['rank4'])) + '건')
        report.append('  5등 (3개 일치): ' + str(len(result['matches']['rank3'])) + '건')
        report.append('')
