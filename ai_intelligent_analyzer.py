                    ...
                    try:
                        ...
                        if data.get("log_type") in ["prediction", "probability"]:
                            ...
                            if nums and len(nums) == 6:
                                ...
                                # 중복 제거: 이미 존재하는 번호 세트면 더 높은 점수 유지
                                if sorted_nums not in unique_candidates or intel_score > unique_candidates[sorted_nums]["intelligent_score"]:
                                    unique_candidates[sorted_nums] = {
...
if __name__ == "__main__":
    # 스크립트 위치 기준 상위 디렉토리를 기본 프로젝트 경로로 사용
